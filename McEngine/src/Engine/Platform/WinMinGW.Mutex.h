/**
* @file mingw.mutex.h
* @brief Partial std::mutex et al implementation for MinGW on Windows
*
* This file is part of the mingw-w64 runtime package.
* No warranty is given; refer to the file DISCLAIMER within this package.
*/

#if (defined(_WIN32) || defined(_WIN64) || defined(__WIN32__) || defined(__CYGWIN__) || defined(__CYGWIN32__) || defined(__TOS_WIN__) || defined(__WINDOWS__)) && !defined(_MSC_VER)
...
// NOTE: this one is broken due to missing try_lock_for() and try_lock_until() in the currently used version of mingw-w64
/*
